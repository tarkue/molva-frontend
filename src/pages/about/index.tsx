      ...
      <data className="flex flex-col gap-3 w-full max-w-[630px]">
        ...
        <span className="text-body text-contrast">
          <p>
            ...
            образовательным траекториям могут делиться честными
            отзывами о предметах. Наша цель — помочь каждому сделать
            осознанный выбор дисциплин, чтобы учебный процесс стал
            прозрачнее, полезнее и интереснее.
          </p>
          <br />
          <br />
          ...
          <ol className="list-decimal ml-5">
            ...
            <li>
              Мы проверяем их на соответствие правилам публикации
            </li>
            <li>
